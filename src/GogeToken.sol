...
import { IDAO, IERC20, IERC20Extended, IUniswapV2Factory, IUniswapV2Router01, IUniswapV2Router02, IDividendPayingToken, IDividendPayingTokenOptional } from "./interfaces/Interfaces.sol";
...
contract DogeGaySon is ERC20, Ownable {
    ...
    constructor(
        ...
        marketingWallet = _marketingWallet; //0xFecf1D51E984856F11B7D0872D40fC2F05377738
        teamWallet = _teamWallet; //0xC1Aa023A8fA820F4ed077f4dF4eBeD0a3351a324

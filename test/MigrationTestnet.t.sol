...
contract MigrationTesting is Utility, Test {
    ...
    function setUp() public {
        ...
        uint TOKEN_DEPOSIT = 67_715_637_123 ether;
        ...
        IUniswapV2Router01(UNIV2_ROUTER).addLiquidityETH{value: 0.574927758 ether}( //0.574927757968749998
        ...
        //gogeToken_v1.updatePair(address(789));     
    ...
    // Initial state test.
    function test_migrationTestnet_init_state() public {
    ...
    function test_migrationTestnet_tryMigrate() public {
        // Warp in time
        //vm.warp(block.timestamp + 30 days);

        // Transfer tokens to Joe so he can migrate.
        gogeToken_v1.transfer(address(joe), 1_000_000 ether);
        
        // Verify 10M v1 and 0 v2 tokens.
        assertEq(gogeToken_v1.balanceOf(address(joe)), 1_000_000 ether);
        ...
        assertEq(gogeToken_v2.balanceOf(address(joe)), 1_000_000 ether);
